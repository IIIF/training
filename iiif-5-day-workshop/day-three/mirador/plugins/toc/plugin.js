...
var toc = (function () {
  ...
  var $_gaxjs5rkjgqkx2u4 = { create: create };

  var tocId = $_gaxjs5rkjgqkx2u4.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_dyz10brjjgqkx2u3.getTocClass(editor);
    var headerTag = $_dyz10brjjgqkx2u3.getTocHeader(editor);
    var selector = generateSelector($_dyz10brjjgqkx2u3.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_dyz10brjjgqkx2u3.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_dyz10brjjgqkx2u3.getTocHeader(editor), global$2.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_5yposurfjgqkx2tx.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_5yposurfjgqkx2tx.updateToc(editor);
    });
  };
  var $_4x7ajnrejgqkx2tw = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_dyz10brjjgqkx2u3.getTocClass(editor);
  ...
  var $_8ndw44rljgqkx2u5 = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_5yposurfjgqkx2tx.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_dyz10brjjgqkx2u3.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_8joj6drmjgqkx2u7 = { register: register$1 };

  global.add('toc', function (editor) {
    $_4x7ajnrejgqkx2tw.register(editor);
    $_8joj6drmjgqkx2u7.register(editor);
    $_8ndw44rljgqkx2u5.setup(editor);
  });
  function Plugin () {
  }

...
The concepts of the Presentataion API can be quite difficult to grasp until we actually start building a manifest.

Learning by doing: In production systems (e.g., digital library image collections), manifests can get very big and are usually machine generated, but for getting the basic concepts down, there is no substitute for making a manifest "by hand."
...
* Here I've created a basic manifest for all of us to share. As you'll notice, it is very sparse.
...
Therefore, in this activity, we want you with a partner to look at the [IIIF Presentation API documentation](http://iiif.io/api/presentation/2.1/) and hunt for an answers to the following questions.

When you think you've found the answer, add it to the manifest above -- you'll need to copy and paste it into a text editor or, better yet, a JSON editor (these aren't hard to find).

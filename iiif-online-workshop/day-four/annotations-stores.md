 ...
 * [Annonatate](https://github.com/iiif-test/annonatate) - hosted annotation store which connects to your GitHub account and allows you to store your annotations publicly using GitHub Pages website

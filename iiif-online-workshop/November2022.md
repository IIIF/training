...
Thank you for registering for the [IIIF Online Workshop](https://www.eventbrite.com/e/november-2022-iiif-online-training-5-day-course-tickets-400723423547) between November 21st to November 25th. This course is an adapted version of an in person workshop and it is the 19th time we have run it online.  
...
<script type="text/javascript">
  ...
  var pref = '<iframe src="https://calendar.google.com/calendar/embed?src=clir.org_chugpdurgjm9njridh8uq676n0%40group.calendar.google.com&mode=WEEK&title=IIIF%20Online%20Workshop&dates=20221121/20221125&showTabs=0&ctz=';
  var suff = '" style="border: 0" width="100%" height="300" frameborder="0" scrolling="no"></iframe>';
  var iframe_html = pref + timezone.name() + suff;
  document.getElementById('calendar-container').innerHTML = iframe_html;
</script>

You can also download a <a href="ics/November2022.ics">ICS version</a>.
...
<iframe src="https://www.google.com/maps/d/embed?mid=1RZ03PAoeAr1bVR93-nT2l1HuXwKYy9o&ehbc=2E312F" width="640" height="480"></iframe>
...
<script type="text/javascript">
    ...
    setDates(dayjs.tz("2022-11-21 09:00", "Europe/London"),"day1", "intro");
    setDates(dayjs.tz("2022-11-22 09:00", "Europe/London"),"day2", "image");
    setDates(dayjs.tz("2022-11-23 09:00", "Europe/London"),"day3", "presentation");
    setDates(dayjs.tz("2022-11-24 09:00", "Europe/London"),"day4", "annotations");
    setDates(dayjs.tz("2022-11-25 09:00", "Europe/London"),"day5", "demos");

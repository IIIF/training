...
Thank you for registering for the [IIIF Online Workshop](https://www.eventbrite.com/e/june-2024-iiif-online-training-5-day-course-tickets-795359239897) between June 17th to June 21st. This course is an adapted version of an in person workshop and it is the 29th time we have run it online.  
...
<script type="text/javascript">
  ...
  var pref = '<iframe src="https://calendar.google.com/calendar/embed?src=clir.org_chugpdurgjm9njridh8uq676n0%40group.calendar.google.com&mode=WEEK&title=IIIF%20Online%20Workshop&dates=20240617/20240621&showTabs=0&ctz=';
  var suff = '" style="border: 0" width="100%" height="300" frameborder="0" scrolling="no"></iframe>';
  var iframe_html = pref + timezone.name() + suff;
  document.getElementById('calendar-container').innerHTML = iframe_html;
</script>

You can also download a <a href="ics/June2024.ics">ICS version</a>.
...
<iframe src="https://www.google.com/maps/d/embed?mid=1EkE3kPRtM8M1tkHnXl1LEr1xrI2T2VU&ehbc=2E312F" width="640" height="480"></iframe>
...
<script type="text/javascript">
    ...
    setDates(dayjs.tz("2024-06-17 14:00", "Europe/London"),"day1", "intro");
    setDates(dayjs.tz("2024-06-18 14:00", "Europe/London"),"day2", "image");
    setDates(dayjs.tz("2024-06-19 14:00", "Europe/London"),"day3", "presentation");
    setDates(dayjs.tz("2024-06-20 14:00", "Europe/London"),"day4", "annotations");
    setDates(dayjs.tz("2024-06-21 14:00", "Europe/London"),"day5", "demos");

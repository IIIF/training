...
Thank you for registering for the [IIIF Online Workshop](https://www.eventbrite.com/e/july-2023-iiif-online-training-5-day-course-tickets-554794684837) between July 10th to July 14th. This course is an adapted version of an in person workshop and it is the 25th time we have run it online.  
...
<script type="text/javascript">
  ...
  var pref = '<iframe src="https://calendar.google.com/calendar/embed?src=clir.org_chugpdurgjm9njridh8uq676n0%40group.calendar.google.com&mode=WEEK&title=IIIF%20Online%20Workshop&dates=20230710/20230714&showTabs=0&ctz=';
...
<script type="text/javascript">
    ...
    setDates(dayjs.tz("2023-07-10 21:00", "Europe/London"),"day1", "intro");
    setDates(dayjs.tz("2023-07-11 21:00", "Europe/London"),"day2", "image");
    setDates(dayjs.tz("2023-07-12 21:00", "Europe/London"),"day3", "presentation");
    setDates(dayjs.tz("2023-07-13 21:00", "Europe/London"),"day4", "annotations");
    setDates(dayjs.tz("2023-07-14 21:00", "Europe/London"),"day5", "demos");

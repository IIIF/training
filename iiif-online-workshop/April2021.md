...
Thank you for registering for the [IIIF Online Workshop](https://www.eventbrite.co.uk/e/march-iiif-online-training-5-day-course-tickets-144662480373) between the 19th and 23th of April 2021. This course is an adapted version of an in person workshop and it is the seventh time we have run it online.  

We are keen to adapt many of the techniques that have worked in person to create an inclusive, productive online version of the workshop. Running an online version does have its complications and one of these is differing timezones and we have participants from Europe, South America and the USA. We appreciate during this time attending all of the sessions will be difficult and so only the [first](day-one/README.md) and [last](day-five/README.md) sessions are **mandatory** to attend live.  
...
<script type="text/javascript">
  ...
  var pref = '<iframe src="https://calendar.google.com/calendar/b/1/embed?height=600&amp;wkst=1&amp;bgcolor=%23ffffff&amp;src=Y2xpci5vcmdfY2h1Z3BkdXJnam05bmpyaWRoOHVxNjc2bjBAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ&amp;color=%23B39DDB&amp;showTabs=0&amp;mode=WEEK&amp;dates=20210419/20210423&amp;title=IIIF%20Online%20Workshop&amp;ctz=';
...
<iframe src="https://www.google.com/maps/d/embed?mid=1256LoYo3t-3VpTxNBJelmdB23tm6qRsw" width="640" height="480"></iframe>
...
<script type="text/javascript">
    ...
    setDates(dayjs.tz("2021-04-19 14:00", "Europe/London"),"day1", "intro");
    setDates(dayjs.tz("2021-04-20 14:00", "Europe/London"),"day2", "image");
    setDates(dayjs.tz("2021-04-21 14:00", "Europe/London"),"day3", "presentation");
    setDates(dayjs.tz("2021-04-22 14:00", "Europe/London"),"day4", "annotations");
    setDates(dayjs.tz("2021-04-23 14:00", "Europe/London"),"day5", "demos");

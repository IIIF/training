...
Thank you for registering for the [IIIF Online Workshop](https://www.eventbrite.com/e/april-2022-iiif-online-training-5-day-course-tickets-266496667707) between the 25th to 29th April. This course is an adapted version of an in person workshop and it is the 13th time we have run it online.  

We are keen to adapt many of the techniques that have worked in person to create an inclusive, productive online version of the workshop. Running an online version does have its complications and one of these is differing timezones and we have participants from the UK, Belgium, Spain, India and the US. We appreciate during this time attending all of the sessions will be difficult and so only the [first](day-one/README.md) and [last](day-five/README.md) sessions are **mandatory** to attend live.  
...
<script type="text/javascript">
  ...
  var pref = '<iframe src="https://calendar.google.com/calendar/embed?src=clir.org_chugpdurgjm9njridh8uq676n0%40group.calendar.google.com&mode=WEEK&title=IIIF%20Online%20Workshop&dates=20220425/20220428&showTabs=0&ctz=';
...
You can also download a <a href="ics/April2022.ics">ICS version</a>.
...
<iframe src="https://www.google.com/maps/d/embed?mid=1Bh-nMj-v0Sbgyxd-8CrOAcbU--PI9tce&ehbc=2E312F" width="640" height="480"></iframe>
...
<script type="text/javascript">
    ...
    setDates(dayjs.tz("2022-04-25 11:00", "Europe/London"),"day1", "intro");
    setDates(dayjs.tz("2022-04-26 11:00", "Europe/London"),"day2", "image");
    setDates(dayjs.tz("2022-04-27 11:00", "Europe/London"),"day3", "presentation");
    setDates(dayjs.tz("2022-03-28 11:00", "Europe/London"),"day4", "annotations");
    setDates(dayjs.tz("2022-04-29 11:00", "Europe/London"),"day5", "demos");

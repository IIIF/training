...
Thank you for registering for the [IIIF Online Workshop](https://www.eventbrite.com/e/july-2023-iiif-online-training-5-day-course-tickets-554794684837) between July 17th to July 21th. This course is an adapted version of an in person workshop and it is the 25th time we have run it online.  
...
<script type="text/javascript">
  ...
  var pref = '<iframe src="https://calendar.google.com/calendar/embed?src=clir.org_chugpdurgjm9njridh8uq676n0%40group.calendar.google.com&mode=WEEK&title=IIIF%20Online%20Workshop&dates=20230717/20230721&showTabs=0&ctz=';
  var suff = '" style="border: 0" width="100%" height="300" frameborder="0" scrolling="no"></iframe>';
  var iframe_html = pref + timezone.name() + suff;
  document.getElementById('calendar-container').innerHTML = iframe_html;
</script>

You can also download a <a href="ics/July2023.ics">ICS version</a>.
...
<iframe src="https://www.google.com/maps/d/embed?mid=1nerJYLJ_Aic4DCpLULvMSj5Rf-amAnM&ehbc=2E312F" width="640" height="480"></iframe>
...
<script type="text/javascript">
    ...
    setDates(dayjs.tz("2023-07-17 21:00", "Europe/London"),"day1", "intro");
    setDates(dayjs.tz("2023-07-18 21:00", "Europe/London"),"day2", "image");
    setDates(dayjs.tz("2023-07-19 21:00", "Europe/London"),"day3", "presentation");
    setDates(dayjs.tz("2023-07-20 21:00", "Europe/London"),"day4", "annotations");
    setDates(dayjs.tz("2023-07-21 21:00", "Europe/London"),"day5", "demos");

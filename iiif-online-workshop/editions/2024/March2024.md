...
Thank you for registering for the [IIIF Online Workshop](https://www.eventbrite.com/e/march-2024-iiif-online-training-5-day-course-tickets-795358006207) between March 18th to March 22nd. This course is an adapted version of an in person workshop and it is the 28th time we have run it online.  
...
<script type="text/javascript">
  ...
  var pref = '<iframe src="https://calendar.google.com/calendar/embed?src=clir.org_chugpdurgjm9njridh8uq676n0%40group.calendar.google.com&mode=WEEK&title=IIIF%20Online%20Workshop&dates=20240318/20240322&showTabs=0&ctz=';
  var suff = '" style="border: 0" width="100%" height="300" frameborder="0" scrolling="no"></iframe>';
  var iframe_html = pref + timezone.name() + suff;
  document.getElementById('calendar-container').innerHTML = iframe_html;
</script>

You can also download a <a href="ics/March2024.ics">ICS version</a>.
...
<iframe src="https://www.google.com/maps/d/embed?mid=1U6ZdeBPYC6XF7zTWViB95H04FTcoezw&ehbc=2E312F" width="640" height="480"></iframe>
...
<script type="text/javascript">
    ...
    setDates(dayjs.tz("2024-03-18 17:00", "Europe/London"),"day1", "intro");
    setDates(dayjs.tz("2024-03-19 17:00", "Europe/London"),"day2", "image");
    setDates(dayjs.tz("2024-03-20 17:00", "Europe/London"),"day3", "presentation");
    setDates(dayjs.tz("2024-03-21 17:00", "Europe/London"),"day4", "annotations");
    setDates(dayjs.tz("2024-03-22 17:00", "Europe/London"),"day5", "demos");

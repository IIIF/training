...
Thank you for registering for the [IIIF Online Workshop](https://www.eventbrite.co.uk/e/372996501577/) between September 19th to September 23rd. This course is an adapted version of an in person workshop and it is the 17th time we have run it online.  
...
<script type="text/javascript">
  ...
  var pref = '<iframe src="https://calendar.google.com/calendar/embed?src=clir.org_chugpdurgjm9njridh8uq676n0%40group.calendar.google.com&mode=WEEK&title=IIIF%20Online%20Workshop&dates=20220919/20220923&showTabs=0&ctz=';
  var suff = '" style="border: 0" width="100%" height="300" frameborder="0" scrolling="no"></iframe>';
  var iframe_html = pref + timezone.name() + suff;
  document.getElementById('calendar-container').innerHTML = iframe_html;
</script>

You can also download a <a href="ics/September2022.ics">ICS version</a>.
...
<iframe src="https://www.google.com/maps/d/embed?mid=1jiU526-N5GOlnaTpFIb6DWXPuRl6IuE&ehbc=2E312F" width="640" height="480"></iframe>
...
<script type="text/javascript">
    ...
    setDates(dayjs.tz("2022-09-19 14:00", "Europe/London"),"day1", "intro");
    setDates(dayjs.tz("2022-09-20 14:00", "Europe/London"),"day2", "image");
    setDates(dayjs.tz("2022-09-21 14:00", "Europe/London"),"day3", "presentation");
    setDates(dayjs.tz("2022-09-22 14:00", "Europe/London"),"day4", "annotations");
    setDates(dayjs.tz("2022-09-23 14:00", "Europe/London"),"day5", "demos");
